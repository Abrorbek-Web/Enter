...
const menuItems: MenuItem[] = [
  { name: "Dashboard", icon: <FaTachometerAlt />, link: "/" },
  {
    ...
    subMenu: [
      { name: "Engineering", icon: null, link: "/list/15" },
      { name: "Procurement", icon: null, link: "/list/16" },
      { name: "Bulk", icon: null, link: "/list/17" },
      { name: "Construction", icon: null, link: "/list/18" },
      { name: "Subcontracts", icon: null, link: "/list/19" },
      { name: "Manpower", icon: null, link: "/list/20" },
      { name: "Machinery", icon: null, link: "/list/21" },
      { name: "Budget", icon: null, link: "/list/22" },
    ],
  },
];
